...
def line(x1, y1, x2, y2, color=BLUE, w=W):
    draw.line([(x1, y1), (x2, y2)], fill=color, width=w)

def circle_outline(cx, cy, r, color=BLUE, w=W):
...
# ── 頭（黒・アウトライン円）────────────────────────────────────────────
circle_outline(108, 42, 14, BLUE)

# ── 胴体（黒）──────────────────────────────────────────────────────────
line(108, 56, 103, 108, BLUE)

# ── 左腕・上げ（黒）────────────────────────────────────────────────────
line(106, 73, 70, 48, BLUE)

# ── 右腕・上げ（黒）────────────────────────────────────────────────────
line(106, 73, 138, 55, BLUE)

# ── 右足：膝上げ（黒）──────────────────────────────────────────────────
line(103, 108, 124, 84,  BLUE)
line(124, 84,  130, 113, BLUE)

# ── 左足：後ろへ伸ばす（黒）────────────────────────────────────────────
line(103, 108, 78, 150, BLUE)
